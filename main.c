...
t_scene	*scene_init(void)
{
	...
	// world = object(PL, plane(vec3(0.0,-1.0,0.0), point3(0.0,-100.0,0.0), color3(0,0.5,0)), color3(0.5,0,0));
	// oadd(&world, object(PL, plane(vec3(0.0,0.0,0.0), point3(0.0,-1000.0,-1000.0), color3(0,0,0.5)), color3(0.5,0,0)));
    scene->world = world;
    lights = object(LIGHT_POINT, light_point(point3(1, 20, 0), color3(1, 1, 1), 0.5), color3(0, 1, 0)); // 더미 albedo
	scene->light = lights;
	ka = 0.1;
	scene->ambient.r = ka;
	scene->ambient.g = ka;
